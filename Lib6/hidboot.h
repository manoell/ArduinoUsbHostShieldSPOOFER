...
struct MOUSEINFO {
        ...
        struct {
                ...
                uint8_t bmBackButton : 1;
                uint8_t bmForwardButton : 1;
                uint8_t bmDummy : 3;
        };
        int8_t dX;
        int8_t dY;
...
protected:
        ...
        virtual void OnBackButtonUp(MOUSEINFO* mi __attribute__((unused))) {
        };

        virtual void OnBackButtonDown(MOUSEINFO* mi __attribute__((unused))) {
        };
        
        virtual void OnForwardButtonUp(MOUSEINFO* mi __attribute__((unused))) {
        };

        virtual void OnForwardButtonDown(MOUSEINFO* mi __attribute__((unused))) {
        };

        virtual void OnWheelMove(MOUSEINFO* mi __attribute__((unused))) {
        };
